...
namespace OpenTK_winforms_z02 {
    public partial class Form1 : Form {
        ...
        private bool statusPiramideTex1;
        private bool statusPiramideTex2;
        private bool statusPiramideTex3;
        private bool statusPiramideTex4;
        ...
        private void SetupValues() {
            ...
            statusPiramideTex1 = false;
            statusPiramideTex2 = false;
            statusPiramideTex3 = false;
            statusPiramideTex4 = false;
            brick = true;
            colorTex = 0;
        }
        ...
        private void GlControl1_Paint(object sender, PaintEventArgs e) {
            ...
            if (statusPiramideTex1 == true)
                DeseneazaPiramidaTextura1();

            if (statusPiramideTex2 == true)
                DeseneazaPiramidaTextura2();

            if (statusPiramideTex3 == true)
                DeseneazaPiramidaTextura3();
            if (statusPiramideTex4 == true)
                DeseneazaPiramidaTextura4();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            resetTexPiram();
            statusPiramideTex1 = true;
            DeseneazaPiramidaTextura1();
            GlControl1.Invalidate();
        }

        private void DeseneazaPiramidaTextura1()
        {
            if (brick == true)
            {
            ...
            GL.Vertex3(pir.A.x, pir.A.y, pir.A.z);
            GL.TexCoord2(1.0, 1.0);
            GL.Vertex3(pir.B.x, pir.B.y, pir.B.z);
            GL.TexCoord2(1.0, 0.0);
            GL.Vertex3(pir.C.x, pir.C.y, pir.C.z);
            GL.TexCoord2(0.0, 0.0);
            GL.Vertex3(pir.D.x, pir.D.y, pir.D.z);
            GL.End();
            ...
            GL.Vertex3(pir.A.x, pir.A.y, pir.A.z);
            GL.TexCoord2(1.0, 1.0);
            GL.Vertex3(pir.E.x, pir.E.y, pir.E.z);
            GL.TexCoord2(1.0, 0.0);
            GL.Vertex3(pir.C.x, pir.C.y, pir.C.z);
            GL.End();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            resetTexPiram();
            statusPiramideTex2 = true;
            DeseneazaPiramidaTextura2();
            GlControl1.Invalidate();
        }

        private void DeseneazaPiramidaTextura2()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
            ...
            GL.Begin(PrimitiveType.Quads);
            GL.TexCoord2(0.0, 5.0);
            GL.Vertex3(pir.A.x, pir.A.y, pir.A.z);
            GL.TexCoord2(5.0, 5.0);
            GL.Vertex3(pir.B.x, pir.B.y, pir.B.z);
            GL.TexCoord2(5.0, 0.0);
            GL.Vertex3(pir.C.x, pir.C.y, pir.C.z);
            GL.TexCoord2(0.0, 0.0);
            GL.Vertex3(pir.D.x, pir.D.y, pir.D.z);
            GL.End();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            resetTexPiram();
            statusPiramideTex3 = true;
            DeseneazaPiramidaTextura3();
            GlControl1.Invalidate();
        }

        private void DeseneazaPiramidaTextura3()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            resetTexCubes();
            resetTexPiram();
            statusPiramideTex4 = true;
            DeseneazaPiramidaTextura4();
            GlControl1.Invalidate();
        }

        private void DeseneazaPiramidaTextura4()
        {
            if (brick == true)
            {
                GL.BindTexture(TextureTarget.Texture2D, textures[0]);
